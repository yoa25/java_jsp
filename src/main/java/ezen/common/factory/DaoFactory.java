...
import ezen.member.repository.JdbcMemberRepositoryT;
...
public class DaoFactory{
	...
	public MemberRepository getMemberRepository() throws ClassNotFoundException, SQLException {
		return new JdbcMemberRepositoryT(dataSource);
	}
